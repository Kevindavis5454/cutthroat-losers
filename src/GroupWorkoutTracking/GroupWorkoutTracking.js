            ...
            .then((contestants) => {
                ...
                if (this.state.contestants[0] !== undefined) {
                    const getWorkoutInfo = () => {
                        return fetch(`${config.API_ENDPOINT}/api/workouts/getDates?contest_id=${localStorage.getItem("contest Id")}&user_id=${this.state.contestants[0]}`)
                            .then(res => res.json())
                    }
                ...
                if (this.state.contestants[1] !== undefined) {
                    const getWorkoutInfo = () => {
                        return fetch(`${config.API_ENDPOINT}/api/workouts/getDates?contest_id=${localStorage.getItem("contest Id")}&user_id=${this.state.contestants[1]}`)
                            .then(res => res.json())
                    }
                    const getContestantInfo = () => {
                ...
                if (this.state.contestants[2] !== undefined) {
                    const getWorkoutInfo = () => {
                        return fetch(`${config.API_ENDPOINT}/api/workouts/getDates?contest_id=${localStorage.getItem("contest Id")}&user_id=${this.state.contestants[2]}`)
                            .then(res => res.json())
                    }
                    const getContestantInfo = () => {
                ...
                if (this.state.contestants[3] !== undefined) {
                    const getWorkoutInfo = () => {
                        return fetch(`${config.API_ENDPOINT}/api/workouts/getDates?contest_id=${localStorage.getItem("contest Id")}&user_id=${this.state.contestants[3]}`)
                            .then(res => res.json())
                    }
                    const getContestantInfo = () => {
